...
namespace GremlinNetSample
{
    ...
    class Program
    {
        ...
        private static string hostname = "demo-graphdb.gremlin.cosmosdb.azure.com";
        private static int port = 443;
        private static string authKey = "DxEgrRMGHB2NN6Is0WutLhk0AkI6A9eSWD0zpWYmvONfY1HB7jdLldWRP9V71PmuQYcO3PRno1CfojZMBCCj9w==";
